...
window.onload = function () {
    ...
    green_audio.src = Modernizr.audio.ogg ? 'src/audio/simonSound1.ogg' : 
                      Modernizr.audio.mp3 ? 'src/audio/simonSound1.mp3' : 
                                            'src/audio/simonSound1.m4a';

    yellow_audio.src = Modernizr.audio.ogg ? 'src/audio/simonSound2.ogg' : 
                       Modernizr.audio.mp3 ? 'src/audio/simonSound2.mp3' : 
                                             'src/audio/simonSound2.m4a';

    red_audio.src = Modernizr.audio.ogg ? 'src/audio/simonSound3.ogg' : 
                    Modernizr.audio.mp3 ? 'src/audio/simonSound3.mp3' : 
                                          'src/audio/simonSound3.m4a';

    blue_audio.src = Modernizr.audio.ogg ? 'src/audio/simonSound4.ogg' : 
                     Modernizr.audio.mp3 ? 'src/audio/simonSound4.mp3' : 
                                           'src/audio/simonSound4.m4a';
    ...
    obj_image.src = 'http://www.w3.org/html/logo/downloads/HTML5_Badge_64.png';    
